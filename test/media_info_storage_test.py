...
class MediaInfoStorageTest(unittest.TestCase):
    ...
    def test_find_season_no_season_attribute(self):
        Storage.add(self.subject, MediaInfo(type='season', path='path3', season='season1'))
        Storage.add(self.subject, MediaInfo(type='season', path='path4', season='season2'))

        search_item = MediaInfo(type='season', path='path1')
    ...
    def test_find_episode_no_season_attribute(self):
        Storage.add(self.subject, MediaInfo(type='episode', path='path5', season='season3', episode="episode1"))
        Storage.add(self.subject, MediaInfo(type='episode', path='path6', season='season4', episode="episode2"))

        search_item = MediaInfo(type='episode', path='path5')
    ...
    def test_find_episode_with_season_attribute_and_episode_attribute(self):
        ...
        search_item = MediaInfo(type='episode', path='path5', season='season3', episode="episode1")
